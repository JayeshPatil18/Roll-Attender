...
public class Request_User extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!sharedPreferences_isLogin.getBoolean("hasLoggedIn",false)){
            ...
            Intent intent = new Intent(Request_User.this, MainActivity.class);
...
//        });
        ...
        AddRequestFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final AlertDialog.Builder adder = new AlertDialog.Builder(Request_User.this);
                                                    ...
                                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                        if (isUserExist[0]){
                                                            ...
                                                            if(!isRequestSent){
                                                                ...
                                                                Toast.makeText(Request_User.this, "Request sent Successfully to " + emailRequest, Toast.LENGTH_SHORT).show();
